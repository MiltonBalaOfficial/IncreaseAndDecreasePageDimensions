...
config.documentBasedAdjustment = false -- If you want "Current document-based" adjustments then set it `false`. (Currently it is set to increase by 100% and decrease by 50%)

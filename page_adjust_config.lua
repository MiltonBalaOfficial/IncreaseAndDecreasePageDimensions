...
config.documentBasedAdjustment = true -- If you want "Current document-based" adjustments then set it `true`, though now it can be done by clicking on `Toggle Document Based Adjustment` when you use the Xournalapp. (Currently it is set to increase by 100% and decrease by 50%)
